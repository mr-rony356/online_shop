...
const ProductsGrid = async ({ fetchProduct, title }: ProductgridProps) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 my-8 gap-8 ">
        {products.map((product) => (
          <div
            key={product.id}
            className="flex flex-col justify-evenly gap-2  border-2 border-gray-100 rounded-lg p-4 transform transition-transform hover:scale-105 cursor-pointer"
          >
